...
////////////
    ...
    var pushOff = OBJ.PushOff = function(arr,value,removed){
                arr.push(value);
                var offValue = arr.shift();
                if(typeof removed === "function") removed(offValue);
                return arr;
    }
    ...
    var unshiftOff = OBJ.UnshiftOff = function(arr,value,removed){
                arr.unshift(value);
                var offValue = arr.pop();
                if(typeof removed === "function") removed(offValue);
                return arr;
    }
